...
In a TTY, you are limited to 16-bit color, and apparently rounding will be used to designate a color. If you are in a terminal window, if your terminal app supports full color, that will be used instead because I'm using ANSI escape codes.
